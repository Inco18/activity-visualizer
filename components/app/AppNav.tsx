  ...
  return (
    <div className="w-full lg:h-full relative lg:w-20 rounded-r-lg">
      <div
        ...
        className="lg:bg-dark-800 bg-black lg:rounded-r-lg lg:max-w-20 lg:hover:max-w-64 transition-all relative lg:absolute z-[2000] lg:h-full peer border-b-[1px] border-white border-opacity-30 lg:border-0">
        ...
        {profileOpen && (
          <div className="hidden lg:block absolute bottom-4 left-full z-[2001] pl-2 w-max">
            <div className="bg-dark-800 w-max rounded-lg overflow-hidden">
              <ul>
                <li>
                  <button
      ...
      <div className="hidden lg:block bg-black z-[1990] w-screen h-screen absolute invisible opacity-0 peer-hover:visible peer-hover:opacity-20 transition-all" />
    </div>
  );
};
